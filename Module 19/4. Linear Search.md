Certainly. Below is the complete and professionally formatted documentation for **EXPERIMENT NO: 1D** – implementation of **Linear Search**, following your preferred layout, academic tone, and structured format:
